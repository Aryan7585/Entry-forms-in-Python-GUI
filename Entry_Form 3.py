...
#Heading
Label(root, text="Welcome to Aryan Travels", font="comicsansms 13 bold", pady=15,bg="black",fg="white").grid(row=0, column=3)
...
Button(text="Submit to Aryan Travels", command=getvals).grid(row=7, column=3)
